...
install_3proxy() {
    ...
    wget https://raw.githubusercontent.com/LiechinFack/Proxy/main/scripts/3proxy.service-Centos8 --output-document=/3proxy/3proxy-0.9.3/scripts/3proxy.service2
